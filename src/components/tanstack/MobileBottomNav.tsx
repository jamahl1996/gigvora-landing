/**
 * Phase 11 — TanStack-native MobileBottomNav.
 * Mirror of src/components/shell/MobileBottomNav.tsx using @tanstack/react-router
 * useLocation hook and the RouterLink shim.
 */
import React from 'react';
import { useLocation } from '@tanstack/react-router';
import {
  Home, BarChart3, MessageSquare, Plus, User,
} from 'lucide-react';
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isCreate ? '' : active ? 'text-primary' : 'text-muted-foreground active:text-foreground',
              )}
            >
              {isCreate ? (
